...
interface skilltreeinterface {
    ...
    skilldivs: HTMLDivElement[]
    skillconnectiondivs: HTMLDivElement[]

    open(): undefined
    init(): undefined
    createtree(): undefined
    createskill(skill: skillinterface): undefined
    createconnection(connection: skillconnectioninterface): undefined
    ...
    newconnection(properties: {
        origin: number
        upgradesrequired: number
        target: number
    }): skillconnectioninterface
}
...
skilltree.newconnection = (properties) => {
    const connection = {} as skillconnectioninterface
